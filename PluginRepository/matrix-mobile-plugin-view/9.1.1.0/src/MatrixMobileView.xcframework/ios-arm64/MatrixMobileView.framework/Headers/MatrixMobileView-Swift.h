...
#ifndef MATRIXMOBILEVIEW_SWIFT_H
#define MATRIXMOBILEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MatrixMobileView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16MatrixMobileView11TTGSnackbar")
...
@interface TTGSnackbar (SWIFT_EXTENSION(MatrixMobileView))
/// Show the snackbar.
- (void)show;
@end
...
SWIFT_CLASS("_TtC16MatrixMobileView16TTGSnackbarLabel")
...
@interface UIColor (SWIFT_EXTENSION(MatrixMobileView))
