...
* @param         {String} callback.statusCode - Status code
* @param         {String} callback.msg - Message
* @param         {String} callback.data - Recognized text
* @param         {Object} options - object
* @param         {String} options.language - Language code (ko-KR: korean, en-US: english, ja-JP: japanese, zh-CN: Simplified Chinese) (Android Only)
* @example
* var callback = function(result){ console.log(result); };
* var options = {};
* options.language = "ko-KR";
* $h.speech.startSpeechToText(callback, options);
*/
$h.speech.startSpeechToText = function (callback, options) {
     try {
        matrixMobile.plugin.speech.startSpeechToText(callback, options);
     } catch (e) {
         console.log(e);
     }
}
